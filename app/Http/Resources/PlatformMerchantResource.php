...
final class PlatformMerchantResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'suspended_at' => $this->suspended_at === null ? null : $this->suspended_at->toIso8601String(),
            'deactivated_at' => $this->deactivated_at === null ? null : $this->deactivated_at->toIso8601String(),
