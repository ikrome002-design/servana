# Screen specification — Super Administrator landing
...
- **Screen key:** `platform-landing`
- **Route name and URL:** `platform.landing`
...
- **Fields and displayed data:** Live Super Administrator role home with header navigation, actions, FAQ, and legal footer.
