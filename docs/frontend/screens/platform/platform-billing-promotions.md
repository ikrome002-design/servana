...
- **Screen key:** `platform-billing-promotions`
- **Route name and URL:** `platform.billing-promotions`
- **Layout:** `PlatformAdminLayout`
- **Allowed roles:** `super_administrator`
- **Required permissions:** `platform.promotion.manage` (frontend visibility only; backend EnsurePermission + policy is authoritative)
