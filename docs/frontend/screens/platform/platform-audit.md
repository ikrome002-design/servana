...
- **Screen key:** `platform-audit`
- **Route name and URL:** `platform.audit`
- **Layout:** `PlatformAdminLayout`
- **Allowed roles:** `super_administrator`
- **Required permissions:** `platform.audit.view` (frontend visibility only; backend EnsurePermission + policy is authoritative)
