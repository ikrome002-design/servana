...
- **Screen key:** `platform-platform-access`
- **Route name and URL:** `platform.platform-access`
- **Layout:** `PlatformAdminLayout`
- **Allowed roles:** `super_administrator`
- **Required permissions:** `platform.internal_access.view`, `platform.internal_access.manage` (frontend visibility only; backend EnsurePermission + policy is authoritative)
