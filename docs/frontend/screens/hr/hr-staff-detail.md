...
- **Screen key:** `hr-staff-detail`
- **Route name and URL:** `hr.staff-detail`
...
- **Fields and displayed data:** Branch-scoped staff identity, readiness, access status, and compensation entry point.
