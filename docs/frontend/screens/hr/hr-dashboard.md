# Screen specification — HR dashboard
...
- **Screen key:** `hr-dashboard`
- **Route name and URL:** `hr.dashboard`
...
- **Fields and displayed data:** Branch-scoped workforce readiness, configuration status, and actionable HR task home.
