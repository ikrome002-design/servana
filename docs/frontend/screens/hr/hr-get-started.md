# Screen specification — HR get-started
...
- **Screen key:** `hr-get-started`
- **Route name and URL:** `hr.get-started`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Guided get-started checklist for HR setup.
