# Screen specification — Staff invitation acceptance
...
- **Screen key:** `staff-invitation-accept`
- **Route name and URL:** `staff.accept`
- **Layout:** `AuthLayout`
...
- **Fields and displayed data:** Invited staff accept their invitation via an emailed token.
