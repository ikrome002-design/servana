# Screen specification — Legal document
...
- **Screen key:** `legal-document`
- **Route name and URL:** `legal.document`
- **Layout:** `Standalone`
...
- **Fields and displayed data:** Compatibility route for the pre-UI-06 /legal/:role/:doc shape. A role equal to the resolved host account redirects to the canonical role-free path; any other role fails closed and renders nothing.
