# Screen specification — Public legal document
...
- **Screen key:** `public-legal`
- **Route name and URL:** `public.legal`
...
- **Fields and displayed data:** The resolved account host's own Data Policy, Privacy Policy or Terms of Service, verbatim, at a role-free path. The document slug is one of three fixed values matched by the route.
