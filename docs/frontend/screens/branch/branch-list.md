# Screen specification — Branch directory
...
- **Screen key:** `branch-list`
- **Route name and URL:** `branch.list`
- **Layout:** `BranchLayout`
- **Allowed roles:** `merchant_administrator`, `merchant_branch`
- **Required permissions:** `merchant.branch.view_all`, `branch.profile.view` (frontend visibility only; backend EnsurePermission + policy is authoritative)
...
- **Fields and displayed data:** Branch directory list.
