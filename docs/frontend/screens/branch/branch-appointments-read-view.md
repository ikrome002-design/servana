...
- **Screen key:** `branch-appointments-read-view`
- **Route name and URL:** `branch.operations-appointments`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Read-only visibility of current and future assigned-branch appointments without Front Office scheduling controls.
