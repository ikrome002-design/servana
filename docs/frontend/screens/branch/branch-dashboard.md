# Screen specification — Branch dashboard
...
- **Screen key:** `branch-dashboard`
- **Route name and URL:** `branch.dashboard`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Live assigned-branch operating home with server-derived readiness, day state, workload, cash-up, catalogue, and performance facts.
