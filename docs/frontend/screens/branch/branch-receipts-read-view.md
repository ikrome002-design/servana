...
- **Screen key:** `branch-receipts-read-view`
- **Route name and URL:** `branch.finance-receipts`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Assigned-branch receipt visibility after Finance validation with no issue, reissue or validation controls.
