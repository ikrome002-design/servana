# Screen specification — Branch Manager get-started
...
- **Screen key:** `branch-get-started`
- **Route name and URL:** `branch.get-started`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Guided get-started checklist for branch setup.
