# Screen specification — Branch account and preferences
...
- **Screen key:** `branch-account-security`
- **Route name and URL:** `branch.account`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Own-scope identity, verified email, MFA, Magic Link sessions, theme preference and account-context switching with Branch wording and no passwords.
