# Screen specification — Branch Manager landing
...
- **Screen key:** `branch-landing`
- **Route name and URL:** `branch.landing`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Live Branch Manager role home.
