...
- **Screen key:** `branch-operating-calendar`
- **Route name and URL:** `branch.branch-calendar`
- **Layout:** `BranchLayout`
...
- **Fields and displayed data:** Canonical Branch account route for weekly operating hours, split sessions and date-specific branch calendar exceptions.
