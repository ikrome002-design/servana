# Screen specification — Public FAQ
...
- **Screen key:** `public-faq`
- **Route name and URL:** `public.faq`
...
- **Fields and displayed data:** The resolved account host's own compiled FAQ, rendered through SvFaq with the source's category dividers preserved. Host-derived: no path segment selects the account.
