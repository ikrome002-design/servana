# Screen specification — Design system demo
...
- **Screen key:** `design-system`
- **Route name and URL:** `dev.design-system`
- **Layout:** `Standalone`
...
- **Fields and displayed data:** Internal design-system gallery used for visual and a11y verification.
