# Screen specification — MFA enrollment
...
- **Screen key:** `mfa-setup`
- **Route name and URL:** `auth.mfa.setup`
- **Layout:** `AuthLayout`
- **Allowed roles:** `all`
...
- **Fields and displayed data:** Mandatory-MFA TOTP enrollment with one-time recovery codes.
