# Screen specification — Merchant self-registration
...
- **Screen key:** `auth-register`
- **Route name and URL:** `auth.register`
- **Layout:** `AuthLayout`
...
- **Fields and displayed data:** The only merchant-creation path: a Merchant Administrator self-registers the business account.
