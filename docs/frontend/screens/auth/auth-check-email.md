# Screen specification — Check your email
...
- **Screen key:** `auth-check-email`
- **Route name and URL:** `auth.check-email`
- **Layout:** `AuthLayout`
...
- **Fields and displayed data:** Confirmation that a Magic Link was sent.
