# Screen specification — Magic Link request
...
- **Screen key:** `auth-login`
- **Route name and URL:** `auth.login`
- **Layout:** `AuthLayout`
...
- **Fields and displayed data:** Request a Magic Link by email; uniform 202 response.
