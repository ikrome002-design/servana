...
- **Screen key:** `audit-flagged-queue`
- **Route name and URL:** `audit.flagged-events`
- **Layout:** `AuditLayout`
...
- **Fields and displayed data:** Branch-scoped flagged-event queue across open/under_review/resolved/dismissed/reopened with status filter, assignee and review-status summaries, and timestamps.
