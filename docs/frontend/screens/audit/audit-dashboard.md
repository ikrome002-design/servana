# Screen specification — Audit dashboard (stub)
...
- **Screen key:** `audit-dashboard`
- **Route name and URL:** `audit.dashboard`
- **Layout:** `AuditLayout`
...
- **Fields and displayed data:** Audit dashboard shell; flagged-event workflows owned by Phase 19.
