# Screen specification — Audit get-started
...
- **Screen key:** `audit-get-started`
- **Route name and URL:** `audit.get-started`
- **Layout:** `AuditLayout`
...
- **Fields and displayed data:** Guided get-started checklist for Audit.
