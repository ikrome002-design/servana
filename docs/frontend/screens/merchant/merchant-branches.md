# Screen specification — Merchant branches
...
- **Screen key:** `merchant-branches`
- **Route name and URL:** `merchant.branches`
...
- **Fields and displayed data:** Tenant-wide branch directory with entitlement-aware creation and canonical owner detail links.
