# Screen specification — Merchant Administrator get-started
...
- **Screen key:** `merchant-get-started`
- **Route name and URL:** `merchant.get-started`
...
- **Fields and displayed data:** Guided get-started checklist for merchant setup.
