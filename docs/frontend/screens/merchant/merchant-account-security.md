# Screen specification — Merchant account and security
...
- **Screen key:** `merchant-account-security`
- **Route name and URL:** `merchant.account`
...
- **Fields and displayed data:** Own-scope identity, verified email, mandatory MFA, Magic Link sessions, theme preference and account-context switching with Merchant-specific wording and no password controls.
