# Screen specification — Merchant dashboard (shell)
...
- **Screen key:** `merchant-dashboard`
- **Route name and URL:** `merchant.dashboard`
...
- **Fields and displayed data:** Merchant dashboard shell; operational widgets owned by later phases.
