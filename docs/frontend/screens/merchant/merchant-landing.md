# Screen specification — Merchant Administrator landing
...
- **Screen key:** `merchant-landing`
- **Route name and URL:** `merchant.landing`
...
- **Fields and displayed data:** Live Merchant Administrator role home with sidebar navigation, actions, FAQ, and legal footer.
