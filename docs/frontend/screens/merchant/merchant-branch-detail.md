# Screen specification — Merchant branch detail
...
- **Screen key:** `merchant-branch-detail`
- **Route name and URL:** `merchant.branch-detail`
...
- **Fields and displayed data:** Scoped owner oversight for one branch with explicit Branch Manager, HR, Front Office and Finance responsibility boundaries and no operational override.
