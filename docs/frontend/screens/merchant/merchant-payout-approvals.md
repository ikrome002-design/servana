...
- **Screen key:** `merchant-payout-approvals`
- **Route name and URL:** `merchant.compensation-payout-approvals`
- **Layout:** `MerchantLayout`
- **Allowed roles:** `merchant_administrator`
- **Required permissions:** `merchant.payout.approve_high_value` (frontend visibility only; backend EnsurePermission + policy is authoritative)
...
- **Fields and displayed data:** Dedicated high-value approval queue using the existing fresh-step-up, idempotency, maker/checker and audit authority. No payout preparation, verification or mark-paid controls.
