...
- **Screen key:** `front-office-account`
- **Route name and URL:** `front-office.account`
...
- **Fields and displayed data:** Signed-in user's own Magic Link identity, MFA enrollment, active sessions, theme preference and assigned branch context; no business, staff-access or notification setting.
