# Screen specification — Front Office get-started
...
- **Screen key:** `front-office-get-started`
- **Route name and URL:** `front-office.get-started`
...
- **Fields and displayed data:** Guided get-started checklist for Front Office.
