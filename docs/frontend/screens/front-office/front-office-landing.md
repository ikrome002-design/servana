# Screen specification — Front Office landing
...
- **Screen key:** `front-office-landing`
- **Route name and URL:** `front-office.landing`
...
- **Fields and displayed data:** Live Front Office role home.
