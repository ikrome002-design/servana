...
- **Screen key:** `front-office-invoices`
- **Route name and URL:** `front-office.invoices`
...
- **Fields and displayed data:** Front Office invoice list (branch-scoped): invoice number or 'Draft', masked client, server-formatted KES total, and status badge. A capability-gated 'New invoice' button (invoice.create) opens the draft builder. No payment or receipt control appears here (Phase 18).
