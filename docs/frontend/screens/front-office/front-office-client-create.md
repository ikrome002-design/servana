# Screen specification — Add client
...
- **Fields and displayed data:** Create a client (name, phone, optional email/notes). A same-branch duplicate phone returns a deterministic conflict linking to the existing record.
