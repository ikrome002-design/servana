# Screen specification — Unsupported role state
...
- **Fields and displayed data:** Fail-safe boundary when an active role identity cannot be resolved.
