...
- **Screen key:** `finance-disputes`
- **Route name and URL:** `finance.disputes`
...
- **Fields and displayed data:** Finance dispute list with a status filter and a capability-gated 'Open dispute' form linked to an invoice and/or a payment record. The disputed source record is never mutated by the investigation.
