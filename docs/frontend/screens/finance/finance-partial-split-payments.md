...
- **Screen key:** `finance-partial-split-payments`
- **Route name and URL:** `finance.payments-partial-split`
...
- **Fields and displayed data:** Read-only assigned-branch invoice reconciliation surface showing server-derived totals, validated paid amount, balance, payment groups, masked components, duplicate state, and receipt outcomes without browser-authored money.
