# Screen specification — Finance dashboard
...
- **Fields and displayed data:** Assigned-branch Finance command centre with server-derived payment, invoice, control, and compensation totals kept separate by currency; priority work links; explicit maker/checker and Wallet/report/notification gate truth; and no client-authored financial facts.
