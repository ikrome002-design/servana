# Screen specification — Finance get-started
...
- **Screen key:** `finance-get-started`
- **Route name and URL:** `finance.get-started`
...
- **Fields and displayed data:** Guided get-started checklist for Finance.
