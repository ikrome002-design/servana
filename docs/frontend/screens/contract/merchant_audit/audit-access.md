# Screen specification — Access and Security Audit
...
- **Page title:** Access and Security Audit
- **Route:** `/audit/access` (host-relative contract path)
- **Route name:** `audit.audit-access`
- **Navigation group:** Audit Views
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_audit.audit-access`
- **Screen key:** `audit-access`
- **Authoritative map section:** §12.4.9
...
- **User story:** As merchant audit, I open Access and Security Audit so that review authentication, invitations, role/permission changes, branch access, lifecycle revocation, and unauthorized access attempts.
