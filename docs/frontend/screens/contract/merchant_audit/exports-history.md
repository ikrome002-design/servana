# Screen specification — Export History
...
- **Route:** `/exports/history` (host-relative contract path)
- **Route name:** `audit.exports-history`
- **Navigation group:** Export
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_audit.exports-history`
- **Screen key:** `exports-history`
- **Authoritative map section:** §12.4.12

## Purpose

- **Purpose:** Review audit export generation and download history.
- **User story:** As merchant audit, I open Export History so that review audit export generation and download history.
