...
- **Route name:** `audit.account`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_audit.account`
- **Screen key:** `account`
- **Authoritative map section:** §12.4.15

## Purpose

- **Purpose:** Manage the Audit user's own identity, sessions, security, branch context, theme, and notifications.
- **User story:** As merchant audit, I open Account and Preferences so that manage the Audit user's own identity, sessions, security, branch context, theme, and notifications.
