# Screen specification — Preferred Personnel and Contact Protection Audit

> GENERATED FILE — do not edit.
> Source: `docs/frontend/navigation/servana-user-account-navigation-map.yaml` · Regenerate: `node scripts/generate-ui07-navigation-contract.mjs`
>
> No runtime page implementation is active. UI-07 registers the contract identity only: **no Vue Router record and no navigation link is exposed**. Owner phase **UI-15** implements it.

## Identity

- **Account:** merchant_audit
- **Host:** `audit.servana.ke`
- **Page title:** Preferred Personnel and Contact Protection Audit
- **Route:** `/audit/privacy-preferred` (host-relative contract path)
- **Route name:** `audit.audit-privacy-preferred`
- **Navigation group:** Audit Views
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_audit.audit-privacy-preferred`
- **Screen key:** `audit-privacy-preferred`
- **Authoritative map section:** §12.4.10

## Purpose

- **Purpose:** Focus review on preferred-personnel overrides, client contact access, SMS, masking, and prohibited export attempts.
- **User story:** As merchant audit, I open Preferred Personnel and Contact Protection Audit so that focus review on preferred-personnel overrides, client contact access, SMS, masking, and prohibited export attempts.
...
- **Icon:** `privacy` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
...
- **Tests:** Contract-level only in UI-07: `Ui07NavigationRegistryContractTest`, `Ui07NoPlannedRouteExposureTest`. Page-level tests are owned by **UI-15**.
- **Screenshot requirements:** None in UI-07 — there is no page to capture. Owner phase **UI-15**.
