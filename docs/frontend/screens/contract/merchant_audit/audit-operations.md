# Screen specification — Operational Audit
...
- **Page title:** Operational Audit
- **Route:** `/audit/operations` (host-relative contract path)
- **Route name:** `audit.audit-operations`
- **Navigation group:** Audit Views
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_audit.audit-operations`
- **Screen key:** `audit-operations`
- **Authoritative map section:** §12.4.6
...
- **User story:** As merchant audit, I open Operational Audit so that review branch clients, appointments, walk-ins, queues, sessions, services, and day operations through audit events and masked context.
