...
- **Contract key:** `merchant_audit.dashboard`
- **Screen key:** `dashboard`
- **Authoritative map section:** §12.4.1

## Purpose

- **Purpose:** Provide a branch-scoped, read-only risk and audit home with a narrow flagged-event review-metadata workflow.
- **User story:** As merchant audit, I open Dashboard so that provide a branch-scoped, read-only risk and audit home with a narrow flagged-event review-metadata workflow.
