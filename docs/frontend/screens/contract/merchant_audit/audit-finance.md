# Screen specification — Finance Audit

> GENERATED FILE — do not edit.
> Source: `docs/frontend/navigation/servana-user-account-navigation-map.yaml` · Regenerate: `node scripts/generate-ui07-navigation-contract.mjs`
>
> A real runtime route renders this page today: `audit.finance` at `/audit/finance` (routes/audit.ts), delivery **dedicated**.

## Identity

- **Account:** merchant_audit
- **Host:** `audit.servana.ke`
- **Page title:** Finance Audit
- **Route:** `/audit/finance` (host-relative contract path)
- **Route name:** `audit.audit-finance`
- **Navigation group:** Audit Views
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_audit.audit-finance`
- **Screen key:** `audit-finance`
- **Authoritative map section:** §12.4.7
...
- **User story:** As merchant audit, I open Finance Audit so that review branch invoice, merchant-client payment, receipt, refund, dispute, cash-up, period-lock, and subscription-billing visibility.
...
- **Runtime route:** `audit.finance`
- **Route delivery:** `dedicated`
- **External gate:** none

## Data and behaviour

- **API dependencies:** `GET /api/v1/me` bootstrap plus the endpoints already backing `audit.finance` (recorded in `docs/frontend/screens/audit/audit-finance.md`).
- **Data fields:** Read-only, branch-scoped, masked finance-domain audit view (Audit via audit.finance.view; Finance via finance.audit.view with server MFA); not a Finance operational screen.
...
- **Permission-any:** — none
- **Permission-all:** `audit.finance.view`
