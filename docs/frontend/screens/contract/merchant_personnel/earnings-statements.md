# Screen specification — Earnings Statements
...
- **Page title:** Earnings Statements
- **Route:** `/earnings/statements` (host-relative contract path)
- **Route name:** `personnel.earnings-statements`
- **Navigation group:** My Earnings
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.earnings-statements`
- **Screen key:** `earnings-statements`
- **Authoritative map section:** §11.4.16

## Purpose

- **Purpose:** Generate and download private own-scope earnings statements.
- **User story:** As merchant personnel, I open Earnings Statements so that generate and download private own-scope earnings statements.
...
- **Icon:** `statement` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
