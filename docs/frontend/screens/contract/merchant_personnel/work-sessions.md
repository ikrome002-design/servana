# Screen specification — My Sessions
...
- **Route:** `/work/sessions` (host-relative contract path)
- **Route name:** `personnel.work-sessions`
- **Navigation group:** My Work
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.work-sessions`
- **Screen key:** `work-sessions`
- **Authoritative map section:** §11.4.5

## Purpose

- **Purpose:** Show service sessions performed by the logged-in Personnel member.
- **User story:** As merchant personnel, I open My Sessions so that show service sessions performed by the logged-in Personnel member.
...
- **Permission-any:** — none
- **Permission-all:** `personnel.my_sessions.view`
