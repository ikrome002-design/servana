# Screen specification — Commission
...
- **Route:** `/earnings/commission` (host-relative contract path)
- **Route name:** `personnel.earnings-commission`
- **Navigation group:** My Earnings
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.earnings-commission`
- **Screen key:** `earnings-commission`
- **Authoritative map section:** §11.4.12

## Purpose

- **Purpose:** Show service-linked commission entries for commission-only or salary-plus-commission Personnel.
- **User story:** As merchant personnel, I open Commission so that show service-linked commission entries for commission-only or salary-plus-commission Personnel.
