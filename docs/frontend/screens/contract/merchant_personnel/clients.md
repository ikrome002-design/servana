# Screen specification — Served Clients
...
- **Page title:** Served Clients
- **Route:** `/clients` (host-relative contract path)
- **Route name:** `personnel.clients`
- **Navigation group:** My Clients
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.clients`
- **Screen key:** `clients`
- **Authoritative map section:** §11.4.8

## Purpose

- **Purpose:** Show only clients personally served by the logged-in Personnel member for permitted relationship follow-up.
- **User story:** As merchant personnel, I open Served Clients so that show only clients personally served by the logged-in Personnel member for permitted relationship follow-up.
...
- **Permission-any:** — none
- **Permission-all:** `personnel.my_served_clients.view`
