# Screen specification — Service History
...
- **Route:** `/work/history` (host-relative contract path)
- **Route name:** `personnel.work-history`
- **Navigation group:** My Work
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.work-history`
- **Screen key:** `work-history`
- **Authoritative map section:** §11.4.6

## Purpose

- **Purpose:** Provide a personal record of completed services and own performance.
- **User story:** As merchant personnel, I open Service History so that provide a personal record of completed services and own performance.
