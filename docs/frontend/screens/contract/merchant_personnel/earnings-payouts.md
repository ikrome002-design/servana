...
- **Page title:** Payouts
- **Route:** `/earnings/payouts` (host-relative contract path)
- **Route name:** `personnel.earnings-payouts`
- **Navigation group:** My Earnings
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.earnings-payouts`
- **Screen key:** `earnings-payouts`
- **Authoritative map section:** §11.4.14

## Purpose

- **Purpose:** Show external compensation payments recorded as paid by Finance.
- **User story:** As merchant personnel, I open Payouts so that show external compensation payments recorded as paid by Finance.
