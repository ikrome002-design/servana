# Screen specification — Preferred Requests
...
- **Page title:** Preferred Requests
- **Route:** `/work/preferred-requests` (host-relative contract path)
- **Route name:** `personnel.work-preferred-requests`
- **Navigation group:** My Work
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.work-preferred-requests`
- **Screen key:** `work-preferred-requests`
- **Authoritative map section:** §11.4.7

## Purpose

- **Purpose:** Show clients who specifically requested the logged-in Personnel member.
- **User story:** As merchant personnel, I open Preferred Requests so that show clients who specifically requested the logged-in Personnel member.
