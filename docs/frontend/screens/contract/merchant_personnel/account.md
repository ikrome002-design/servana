...
- **Route name:** `personnel.account`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.account`
- **Screen key:** `account`
- **Authoritative map section:** §11.4.20

## Purpose

- **Purpose:** Manage Personnel's own identity, sessions, accessibility, theme, and notifications.
- **User story:** As merchant personnel, I open Account and Preferences so that manage Personnel's own identity, sessions, accessibility, theme, and notifications.
