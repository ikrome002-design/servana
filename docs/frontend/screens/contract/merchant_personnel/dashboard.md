...
- **Route name:** `personnel.dashboard`
- **Navigation group:** Home
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.dashboard`
- **Screen key:** `dashboard`
- **Authoritative map section:** §11.4.1

## Purpose

- **Purpose:** Provide each service provider with a private, mobile-first own-work and own-earnings home.
- **User story:** As merchant personnel, I open Dashboard so that provide each service provider with a private, mobile-first own-work and own-earnings home.
