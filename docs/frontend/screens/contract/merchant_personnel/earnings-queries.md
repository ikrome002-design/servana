...
- **Route:** `/earnings/queries` (host-relative contract path)
- **Route name:** `personnel.earnings-queries`
- **Navigation group:** My Earnings
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_personnel.earnings-queries`
- **Screen key:** `earnings-queries`
- **Authoritative map section:** §11.4.17

## Purpose

- **Purpose:** Create and track questions about own compensation without directly editing financial records.
- **User story:** As merchant personnel, I open Earnings Queries so that create and track questions about own compensation without directly editing financial records.
