# Screen specification — Daily Activity

> GENERATED FILE — do not edit.
> Source: `docs/frontend/navigation/servana-user-account-navigation-map.yaml` · Regenerate: `node scripts/generate-ui07-navigation-contract.mjs`
>
> A real runtime route renders this page today: `front-office.activity` at `/activity` (routes/frontOffice.ts), delivery **dedicated**.
...
- **Route:** `/activity` (host-relative contract path)
- **Route name:** `front-office.activity`
- **Navigation group:** Quick Access
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_front_office.activity`
- **Screen key:** `activity`
- **Authoritative map section:** §10.4.16

## Purpose

- **Purpose:** Provide a chronological branch work log for the current day.
- **User story:** As merchant front office, I open Daily Activity so that provide a chronological branch work log for the current day.

## Ownership and status

- **UI owner phase:** **UI-13**
- **Backend owner phase:** **Phase UI-13**
- **Implementation status:** `implemented`
- **Runtime route:** `front-office.activity`
- **Route delivery:** `dedicated`
- **External gate:** none

## Data and behaviour

- **API dependencies:** `GET /api/v1/me` bootstrap plus the endpoints already backing `front-office.activity` (recorded in `docs/frontend/screens/front-office/front-office-payment-recording.md`).
- **Data fields:** Narrow, paginated same-day branch operational timeline derived from append-only audit facts without raw Audit-account payloads.
...
- **Permission-any:** — none
- **Permission-all:** `front_office.search`
...
- **Icon:** `activity` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
