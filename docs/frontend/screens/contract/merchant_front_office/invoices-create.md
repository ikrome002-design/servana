# Screen specification — Create Invoice
...
- **Route:** `/invoices/create` (host-relative contract path)
- **Route name:** `front-office.invoices-create`
- **Navigation group:** Billing Client › Invoices
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_front_office.invoices-create`
- **Screen key:** `invoices-create`
- **Authoritative map section:** §10.4.13

## Purpose

- **Purpose:** Build and finalize an invoice from completed service activity.
- **User story:** As merchant front office, I open Create Invoice so that build and finalize an invoice from completed service activity.
