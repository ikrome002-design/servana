# Screen specification — Client Detail
...
- **Page title:** Client Detail
- **Route:** `/clients/:clientUlid` (host-relative contract path)
- **Route name:** `front-office.client-detail`
- **Navigation group:** Clients
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_front_office.client-detail`
- **Screen key:** `client-detail`
- **Authoritative map section:** §10.4.6

## Purpose

- **Purpose:** Show a branch client's profile and service history needed for front-office operations.
- **User story:** As merchant front office, I open Client Detail so that show a branch client's profile and service history needed for front-office operations.
