...
>
> Blocked by **phase_21n_blocked_by_external_gate_w**. The navigation entry is rendered disabled and names the gate; it has no live destination, and no Wallet, Refer & Earn, notification or provider runtime exists behind it. Owner phase **UI-13** implements the page once the gate opens.
...
- **Route name:** `front-office.notifications`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_front_office.notifications`
- **Screen key:** `notifications`
- **Authoritative map section:** §10.4.18

## Purpose

- **Purpose:** Centralize operational, validation, receipt, queue, appointment, and billing notices.
- **User story:** As merchant front office, I open Notifications so that centralize operational, validation, receipt, queue, appointment, and billing notices.
