...
- **Page title:** Payment and Receipt Status
- **Route:** `/payments/status` (host-relative contract path)
- **Route name:** `front-office.payments-status`
- **Navigation group:** Billing Client
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_front_office.payments-status`
- **Screen key:** `payments-status`
- **Authoritative map section:** §10.4.15

## Purpose

- **Purpose:** Track recorded groups through Finance validation and receipt availability.
- **User story:** As merchant front office, I open Payment and Receipt Status so that track recorded groups through Finance validation and receipt availability.
