...
- **Route name:** `front-office.account`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_front_office.account`
- **Screen key:** `account`
- **Authoritative map section:** §10.4.19

## Purpose

- **Purpose:** Manage the Front Office user's own profile, sessions, preferences, and branch context.
- **User story:** As merchant front office, I open Account and Preferences so that manage the Front Office user's own profile, sessions, preferences, and branch context.
