# Screen specification — Create Client
...
- **Route:** `/clients/create` (host-relative contract path)
- **Route name:** `front-office.clients-create`
- **Navigation group:** Clients
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_front_office.clients-create`
- **Screen key:** `clients-create`
- **Authoritative map section:** §10.4.5

## Purpose

- **Purpose:** Create a branch-scoped client record with server-side duplicate-phone prevention and consent capture.
- **User story:** As merchant front office, I open Create Client so that create a branch-scoped client record with server-side duplicate-phone prevention and consent capture.
