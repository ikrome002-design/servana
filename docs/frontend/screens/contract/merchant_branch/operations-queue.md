# Screen specification — Queue Read View
...
- **Page title:** Queue Read View
- **Route:** `/operations/queue` (host-relative contract path)
- **Route name:** `branch.operations-queue`
- **Navigation group:** Operational Visibility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_branch.operations-queue`
- **Screen key:** `operations-queue`
- **Authoritative map section:** §7.4.8

## Purpose

- **Purpose:** Monitor the branch queue without taking over Front Office assignment or transfer ownership.
- **User story:** As merchant branch, I open Queue Read View so that monitor the branch queue without taking over Front Office assignment or transfer ownership.
