# Screen specification — Receipts Read View

> GENERATED FILE — do not edit.
> Source: `docs/frontend/navigation/servana-user-account-navigation-map.yaml` · Regenerate: `node scripts/generate-ui07-navigation-contract.mjs`
>
> A real runtime route renders this page today: `branch.finance-receipts` at `/finance/receipts` (routes/branch.ts), delivery **dedicated**.

## Identity

- **Account:** merchant_branch
- **Host:** `branch.servana.ke`
- **Page title:** Receipts Read View
- **Route:** `/finance/receipts` (host-relative contract path)
- **Route name:** `branch.finance-receipts`
- **Navigation group:** Financial Visibility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_branch.finance-receipts`
- **Screen key:** `finance-receipts`
- **Authoritative map section:** §7.4.12

## Purpose

- **Purpose:** Provide branch receipt visibility after Finance validation.
- **User story:** As merchant branch, I open Receipts Read View so that provide branch receipt visibility after Finance validation.
...
- **Runtime route:** `branch.finance-receipts`
- **Route delivery:** `dedicated`
- **External gate:** none

## Data and behaviour

- **API dependencies:** `GET /api/v1/me` bootstrap plus the endpoints already backing `branch.finance-receipts` (recorded in `docs/frontend/screens/branch/branch-receipts-read-view.md`).
- **Data fields:** Assigned-branch receipt visibility after Finance validation with no issue, reissue or validation controls.
