# Screen specification — Appointments Read View
...
- **Page title:** Appointments Read View
- **Route:** `/operations/appointments` (host-relative contract path)
- **Route name:** `branch.operations-appointments`
- **Navigation group:** Operational Visibility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_branch.operations-appointments`
- **Screen key:** `operations-appointments`
- **Authoritative map section:** §7.4.9

## Purpose

- **Purpose:** Monitor today's and future branch appointments without performing Front Office scheduling or transfer actions.
- **User story:** As merchant branch, I open Appointments Read View so that monitor today's and future branch appointments without performing Front Office scheduling or transfer actions.
