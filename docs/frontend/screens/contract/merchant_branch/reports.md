# Screen specification — Branch Reports
...
- **Page title:** Branch Reports
- **Route:** `/reports` (host-relative contract path)
- **Route name:** `branch.reports`
- **Navigation group:** Reporting
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_branch.reports`
- **Screen key:** `reports`
- **Authoritative map section:** §7.4.14

## Purpose

- **Purpose:** Provide branch-scoped operational, service, queue, day-close, cash-up, and financial visibility.
- **User story:** As merchant branch, I open Branch Reports so that provide branch-scoped operational, service, queue, day-close, cash-up, and financial visibility.
