# Screen specification — Branch Day Operations

> GENERATED FILE — do not edit.
> Source: `docs/frontend/navigation/servana-user-account-navigation-map.yaml` · Regenerate: `node scripts/generate-ui07-navigation-contract.mjs`
>
> A real runtime route renders this page today: `branch.branch-day` at `/branch/day` (routes/branch.ts), delivery **dedicated**.

## Identity

- **Account:** merchant_branch
- **Host:** `branch.servana.ke`
- **Page title:** Branch Day Operations
- **Route:** `/branch/day` (host-relative contract path)
- **Route name:** `branch.branch-day`
- **Navigation group:** Branch Operations
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_branch.branch-day`
- **Screen key:** `branch-day`
- **Authoritative map section:** §7.4.5

## Purpose

- **Purpose:** Control the branch business-day lifecycle and make close requirements explicit.
- **User story:** As merchant branch, I open Branch Day Operations so that control the branch business-day lifecycle and make close requirements explicit.
...
- **Runtime route:** `branch.branch-day`
- **Route delivery:** `dedicated`
- **External gate:** none

## Data and behaviour

- **API dependencies:** `GET /api/v1/me` bootstrap plus the endpoints already backing `branch.branch-day` (recorded in `docs/frontend/screens/branch/branch-day-operations.md`).
- **Data fields:** Server-authoritative branch business-day state machine with explicit opening, closing and unresolved close-blocker treatment.
...
- **Icon:** `day` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
