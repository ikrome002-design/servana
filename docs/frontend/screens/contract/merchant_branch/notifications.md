...
- **Route name:** `branch.notifications`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_branch.notifications`
- **Screen key:** `notifications`
- **Authoritative map section:** §7.4.17

## Purpose

- **Purpose:** Show branch-day, catalogue, staffing-readiness, cash-up, billing, and operational alerts.
- **User story:** As merchant branch, I open Notifications so that show branch-day, catalogue, staffing-readiness, cash-up, billing, and operational alerts.
