# Screen specification — Staff Performance
...
- **Route:** `/reports/staff` (host-relative contract path)
- **Route name:** `merchant.reports-staff`
- **Navigation group:** Reports
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.reports-staff`
- **Screen key:** `reports-staff`
- **Authoritative map section:** §6.4.17
...
- **User story:** As merchant administrator, I open Staff Performance so that provide owner-level performance oversight by branch and individual staff while protecting compensation and client privacy.
