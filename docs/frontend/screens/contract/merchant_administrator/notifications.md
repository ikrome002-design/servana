...
- **Route name:** `merchant.notifications`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.notifications`
- **Screen key:** `notifications`
- **Authoritative map section:** §6.4.22
...
- **User story:** As merchant administrator, I open Notifications so that centralize owner alerts for billing, pricing, branches, staff lifecycle, compensation approvals, period approvals, and daily reports.
