# Screen specification — Plan Management
...
- **Route:** `/subscription/plan` (host-relative contract path)
- **Route name:** `merchant.subscription-plan`
- **Navigation group:** Subscription & Billing
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.subscription-plan`
- **Screen key:** `subscription-plan`
- **Authoritative map section:** §6.4.9

## Purpose

- **Purpose:** Compare plans and schedule a plan or billing-interval change for the next billing cycle.
- **User story:** As merchant administrator, I open Plan Management so that compare plans and schedule a plan or billing-interval change for the next billing cycle.
...
- **Permission-any:** — none
- **Permission-all:** `merchant.subscription.plan_change`
