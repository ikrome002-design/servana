# Screen specification — Merchant Reports
...
- **Host:** `servana.ke`
- **Page title:** Merchant Reports
- **Route:** `/reports` (host-relative contract path)
- **Route name:** `merchant.reports`
- **Navigation group:** Reports
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.reports`
- **Screen key:** `reports`
- **Authoritative map section:** §6.4.14

## Purpose

- **Purpose:** Provide tenant-wide, precisely defined business, billing, operational, and compensation reporting.
- **User story:** As merchant administrator, I open Merchant Reports so that provide tenant-wide, precisely defined business, billing, operational, and compensation reporting.
