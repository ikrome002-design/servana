# Screen specification — Service Revenue
...
- **Host:** `servana.ke`
- **Page title:** Service Revenue
- **Route:** `/reports/services` (host-relative contract path)
- **Route name:** `merchant.reports-services`
- **Navigation group:** Reports
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.reports-services`
- **Screen key:** `reports-services`
- **Authoritative map section:** §6.4.16

## Purpose

- **Purpose:** Show service-level revenue and demand across branches without permitting catalogue edits.
- **User story:** As merchant administrator, I open Service Revenue so that show service-level revenue and demand across branches without permitting catalogue edits.
