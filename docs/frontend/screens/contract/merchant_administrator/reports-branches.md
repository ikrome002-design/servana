# Screen specification — Branch Performance
...
- **Host:** `servana.ke`
- **Page title:** Branch Performance
- **Route:** `/reports/branches` (host-relative contract path)
- **Route name:** `merchant.reports-branches`
- **Navigation group:** Reports
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.reports-branches`
- **Screen key:** `reports-branches`
- **Authoritative map section:** §6.4.15

## Purpose

- **Purpose:** Compare branches using consistent operational and financial metrics.
- **User story:** As merchant administrator, I open Branch Performance so that compare branches using consistent operational and financial metrics.
