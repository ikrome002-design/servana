# Screen specification — First-Time Setup
...
- **Route:** `/setup` (host-relative contract path)
- **Route name:** `merchant.setup`
- **Navigation group:** Pre-dashboard onboarding
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.setup`
- **Screen key:** `setup`
- **Authoritative map section:** §6.4.1

## Purpose

- **Purpose:** Complete the mandatory merchant-owner setup before the first operational dashboard visit.
- **User story:** As merchant administrator, I open First-Time Setup so that complete the mandatory merchant-owner setup before the first operational dashboard visit.
...
- **Icon:** `setup` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
