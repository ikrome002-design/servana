# Screen specification — Daily Reports Archive
...
- **Host:** `servana.ke`
- **Page title:** Daily Reports Archive
- **Route:** `/reports/daily` (host-relative contract path)
- **Route name:** `merchant.reports-daily`
- **Navigation group:** Reports
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.reports-daily`
- **Screen key:** `reports-daily`
- **Authoritative map section:** §6.4.21

## Purpose

- **Purpose:** Store and deliver branch day-close and cash-up/reconciliation PDFs to the authorized merchant owner.
- **User story:** As merchant administrator, I open Daily Reports Archive so that store and deliver branch day-close and cash-up/reconciliation PDFs to the authorized merchant owner.
...
- **Icon:** `report` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
