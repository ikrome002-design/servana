# Screen specification — Subscription Invoices
...
- **Host:** `servana.ke`
- **Page title:** Subscription Invoices
- **Route:** `/subscription/invoices` (host-relative contract path)
- **Route name:** `merchant.subscription-invoices`
- **Navigation group:** Subscription & Billing
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.subscription-invoices`
- **Screen key:** `subscription-invoices`
- **Authoritative map section:** §6.4.10

## Purpose

- **Purpose:** List and manage merchant-to-Servana subscription invoices and related billing documents.
- **User story:** As merchant administrator, I open Subscription Invoices so that list and manage merchant-to-Servana subscription invoices and related billing documents.
