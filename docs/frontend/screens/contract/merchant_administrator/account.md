...
- **Route name:** `merchant.account`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.account`
- **Screen key:** `account`
- **Authoritative map section:** §6.4.23

## Purpose

- **Purpose:** Manage the merchant owner's own profile, Magic Link sessions, security, preferences, and business-context switching.
- **User story:** As merchant administrator, I open Account and Security so that manage the merchant owner's own profile, Magic Link sessions, security, preferences, and business-context switching.
