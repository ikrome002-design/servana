# Screen specification — Merchant Profile
...
- **Route:** `/merchant/profile` (host-relative contract path)
- **Route name:** `merchant.merchant-profile`
- **Navigation group:** Merchant
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.merchant-profile`
- **Screen key:** `merchant-profile`
- **Authoritative map section:** §6.4.4
...
- **User story:** As merchant administrator, I open Merchant Profile so that manage tenant-level business identity and branding used across branches, invoices, receipts, reports, and billing communications.
...
- **Permission-any:** — none
- **Permission-all:** `merchant.profile.view`
