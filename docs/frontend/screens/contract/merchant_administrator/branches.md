# Screen specification — Branches

> GENERATED FILE — do not edit.
> Source: `docs/frontend/navigation/servana-user-account-navigation-map.yaml` · Regenerate: `node scripts/generate-ui07-navigation-contract.mjs`
>
> A real runtime route renders this page today: `merchant.branches` at `/branches` (routes/merchant.ts), delivery **dedicated**.
...
- **Host:** `servana.ke`
- **Page title:** Branches
- **Route:** `/branches` (host-relative contract path)
- **Route name:** `merchant.branches`
- **Navigation group:** Merchant
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_administrator.branches`
- **Screen key:** `branches`
- **Authoritative map section:** §6.4.5

## Purpose

- **Purpose:** Create and oversee merchant branches within plan entitlements.
- **User story:** As merchant administrator, I open Branches so that create and oversee merchant branches within plan entitlements.
...
- **Runtime route:** `merchant.branches`
- **Route delivery:** `dedicated`
- **External gate:** none

## Data and behaviour

- **API dependencies:** `GET /api/v1/me` bootstrap plus the endpoints already backing `merchant.branches` (recorded in `docs/frontend/screens/merchant/merchant-branches.md`).
- **Data fields:** Tenant-wide branch directory with entitlement-aware creation and canonical owner detail links.
