# Screen specification — Compensation Change History

> GENERATED FILE — do not edit.
> Source: `docs/frontend/navigation/servana-user-account-navigation-map.yaml` · Regenerate: `node scripts/generate-ui07-navigation-contract.mjs`
>
> A real runtime route renders this page today: `hr.compensation-history` at `/compensation/:staffUlid/history` (routes/hr.ts), delivery **dedicated**.

## Identity

- **Account:** merchant_human_resource
- **Host:** `hr.servana.ke`
- **Page title:** Compensation Change History
- **Route:** `/compensation/:staffUlid/history` (host-relative contract path)
- **Route name:** `hr.compensation-history`
- **Navigation group:** Compensation › Compensation Detail
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_human_resource.compensation-history`
- **Screen key:** `compensation-history`
- **Authoritative map section:** §8.4.14

## Purpose

- **Purpose:** Preserve and explain every compensation version and approval decision.
- **User story:** As merchant human resource, I open Compensation Change History so that preserve and explain every compensation version and approval decision.

## Ownership and status

- **UI owner phase:** **UI-11**
- **Backend owner phase:** **Phase 20F (UI-11 canonical composition)**
- **Implementation status:** `implemented`
- **Runtime route:** `hr.compensation-history`
- **Route delivery:** `dedicated`
- **External gate:** none

## Data and behaviour

- **API dependencies:** `GET /api/v1/me` bootstrap plus the endpoints already backing `hr.compensation-history` (recorded in `docs/frontend/screens/hr/hr-compensation-history.md`).
- **Data fields:** Append-only compensation plan event history for one branch-scoped staff member.
...
- **Permission-any:** — none
- **Permission-all:** `compensation.history.view`
...
- **Icon:** `history` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
