# Screen specification — HR Reports
...
- **Route name:** `hr.reports`
- **Navigation group:** Reporting
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_human_resource.reports`
- **Screen key:** `reports`
- **Authoritative map section:** §8.4.16

## Purpose

- **Purpose:** Provide staff status, availability, eligibility, compensation configuration, and change reporting.
- **User story:** As merchant human resource, I open HR Reports so that provide staff status, availability, eligibility, compensation configuration, and change reporting.
