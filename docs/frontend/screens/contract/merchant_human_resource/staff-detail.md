# Screen specification — Staff Detail
...
- **Host:** `hr.servana.ke`
- **Page title:** Staff Detail
- **Route:** `/staff/:staffUlid` (host-relative contract path)
- **Route name:** `hr.staff-detail`
- **Navigation group:** Staff
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_human_resource.staff-detail`
- **Screen key:** `staff-detail`
- **Authoritative map section:** §8.4.5

## Purpose

- **Purpose:** Provide a complete branch-scoped staff profile, access, readiness, history, and compensation entry point.
- **User story:** As merchant human resource, I open Staff Detail so that provide a complete branch-scoped staff profile, access, readiness, history, and compensation entry point.
