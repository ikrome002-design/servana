# Screen specification — Invite Staff
...
- **Host:** `hr.servana.ke`
- **Page title:** Invite Staff
- **Route:** `/staff/invite` (host-relative contract path)
- **Route name:** `hr.staff-invite`
- **Navigation group:** Staff
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_human_resource.staff-invite`
- **Screen key:** `staff-invite`
- **Authoritative map section:** §8.4.4

## Purpose

- **Purpose:** Create an invitation for an operational merchant user in the assigned branch.
- **User story:** As merchant human resource, I open Invite Staff so that create an invitation for an operational merchant user in the assigned branch.
...
- **Icon:** `invite` (Heroicons, resolved through the curated navigation icon registry — no emoji, no runtime arbitrary lookup).
