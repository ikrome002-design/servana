# Screen specification — HR Audit Activity
...
- **Host:** `hr.servana.ke`
- **Page title:** HR Audit Activity
- **Route:** `/audit` (host-relative contract path)
- **Route name:** `hr.audit`
- **Navigation group:** Reporting
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_human_resource.audit`
- **Screen key:** `audit`
- **Authoritative map section:** §8.4.17

## Purpose

- **Purpose:** Review branch HR, access, eligibility, availability, compensation, and payout-preparation events.
- **User story:** As merchant human resource, I open HR Audit Activity so that review branch HR, access, eligibility, availability, compensation, and payout-preparation events.
