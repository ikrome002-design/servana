...
>
> A real runtime route renders this page today: `hr.dashboard` at `/dashboard` (routes/hr.ts), delivery **dedicated**.
...
- **Route name:** `hr.dashboard`
- **Navigation group:** Home
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_human_resource.dashboard`
- **Screen key:** `dashboard`
- **Authoritative map section:** §8.4.1
...
- **User story:** As merchant human resource, I open Dashboard so that provide a branch-scoped workforce, access, eligibility, availability, compensation, payout-preparation, and HR-task home.

## Ownership and status

- **UI owner phase:** **UI-11**
- **Backend owner phase:** **Phase UI-11 (COR-UI11-001)**
- **Implementation status:** `implemented`
- **Runtime route:** `hr.dashboard`
- **Route delivery:** `dedicated`
- **External gate:** none

## Data and behaviour

- **API dependencies:** `GET /api/v1/me` bootstrap plus the endpoints already backing `hr.dashboard` (recorded in `docs/frontend/screens/hr/hr-dashboard.md`).
- **Data fields:** Branch-scoped workforce readiness, configuration status, and actionable HR task home.
