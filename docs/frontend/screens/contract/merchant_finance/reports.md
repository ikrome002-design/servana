# Screen specification — Finance Reports
...
- **Contract key:** `merchant_finance.reports`
- **Screen key:** `reports`
- **Authoritative map section:** §9.4.20

## Purpose

- **Purpose:** Provide defined branch financial, cash-up, liability, payout, and subscription reports.
- **User story:** As merchant finance, I open Finance Reports so that provide defined branch financial, cash-up, liability, payout, and subscription reports.

## Ownership and status

- **UI owner phase:** **UI-12**
- **Backend owner phase:** **Phase 21N**
