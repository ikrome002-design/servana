...
- **Route name:** `finance.notifications`
- **Navigation group:** Utility
- **Navigation placement:** sidebar primary navigation
- **Contract key:** `merchant_finance.notifications`
- **Screen key:** `notifications`
- **Authoritative map section:** §9.4.23

## Purpose

- **Purpose:** Centralize Finance validation, reconciliation, close, payout, subscription, and security alerts.
- **User story:** As merchant finance, I open Notifications so that centralize Finance validation, reconciliation, close, payout, subscription, and security alerts.
