# Screen specification — Subscription Billing
...
- **User story:** As merchant finance, I open Subscription Billing so that provide Finance with detailed branch/merchant subscription billing, amount-due, invoice, allocation, and recovery visibility.
