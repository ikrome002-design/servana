# Screen specification — Platform Reports
...
- **Page title:** Platform Reports
- **Route:** `/reports` (host-relative contract path)
- **Route name:** `platform.reports`
- **Navigation group:** Reporting & Audit
- **Navigation placement:** header primary navigation
- **Contract key:** `super_administrator.reports`
- **Screen key:** `reports`
- **Authoritative map section:** §5.4.17

## Purpose

- **Purpose:** Provide precise, filterable platform business, billing, registration, integration, and risk reports.
- **User story:** As super administrator, I open Platform Reports so that provide precise, filterable platform business, billing, registration, integration, and risk reports.
