# Screen specification — Free-Period Offers
...
- **Page title:** Free-Period Offers
- **Route:** `/billing/free-periods` (host-relative contract path)
- **Route name:** `platform.billing-free-periods`
- **Navigation group:** Billing & Commercial
- **Navigation placement:** header primary navigation
- **Contract key:** `super_administrator.billing-free-periods`
- **Screen key:** `billing-free-periods`
- **Authoritative map section:** §5.4.7

## Purpose

- **Purpose:** Configure targeted free-period offers that extend trial entitlement without mutating existing trial snapshots.
- **User story:** As super administrator, I open Free-Period Offers so that configure targeted free-period offers that extend trial entitlement without mutating existing trial snapshots.
