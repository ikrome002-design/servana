# Screen specification — Refer & Earn Qualification Decisions
...
- **Page title:** Refer & Earn Qualification Decisions
- **Route:** `/integrations/refer-and-earn/qualifications` (host-relative contract path)
- **Route name:** `platform.integrations-refer-and-earn-qualifications`
- **Navigation group:** Integrations
- **Navigation placement:** header primary navigation
- **Contract key:** `super_administrator.integrations-refer-and-earn-qualifications`
- **Screen key:** `integrations-refer-and-earn-qualifications`
- **Authoritative map section:** §5.4.16
...
- **User story:** As super administrator, I open Refer & Earn Qualification Decisions so that review Servana-source referral attribution facts, active-use qualification decisions, corrections, and reconciliation evidence.
