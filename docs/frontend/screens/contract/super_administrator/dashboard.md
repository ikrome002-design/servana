...
>
> A real runtime route renders this page today: `platform.dashboard` at `/dashboard` (routes/platform.ts), delivery **dedicated**.
...
- **Route name:** `platform.dashboard`
- **Navigation group:** Home
- **Navigation placement:** header primary navigation
- **Contract key:** `super_administrator.dashboard`
- **Screen key:** `dashboard`
- **Authoritative map section:** §5.4.1
...
- **User story:** As super administrator, I open Dashboard so that provide the Citrus platform owner with a live governance, commercial, billing, integration, risk, and audit control centre across all self-registered merchants.
