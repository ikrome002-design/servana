...
- **Route name:** `platform.notifications`
- **Navigation group:** Utility
- **Navigation placement:** header primary navigation
- **Contract key:** `super_administrator.notifications`
- **Screen key:** `notifications`
- **Authoritative map section:** §5.4.21

## Purpose

- **Purpose:** Centralize platform governance, billing, integration, registration, and security alerts.
- **User story:** As super administrator, I open Notifications so that centralize platform governance, billing, integration, registration, and security alerts.
