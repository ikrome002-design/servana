...
- **Screen key:** `personnel-appointments`
- **Route name and URL:** `personnel.appointments`
- **Layout:** `PersonnelLayout`
- **Allowed roles:** `merchant_personnel`
- **Required permissions:** `personnel.my_appointments.view` (frontend visibility only; backend EnsurePermission + policy is authoritative)
