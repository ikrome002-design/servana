# Screen specification — Personnel get-started
...
- **Screen key:** `personnel-get-started`
- **Route name and URL:** `personnel.get-started`
...
- **Fields and displayed data:** Guided get-started checklist for Personnel.
