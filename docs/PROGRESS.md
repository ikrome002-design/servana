...
| 18A | Merchant-client payment recording (Correction 18) | 🔄 `in_progress` — branch `phase-18a-payment-recording`, base `6557469` (verified Phase 17 merge, PR #29). Specification-first gate in progress. See Phase 18A section. |
...
## Phase 18A — Merchant-Client Payment Recording (in_progress)
...
3. **Lifecycle status:** 🔄 `in_progress` — specification-first gate. **Not** `local_complete`/`ci_passed`/`merged`/`verified_complete`.
