...
| UI-03 | Authentication, session family, account switching | 🟡 `in_progress` | `phase-ui-03-auth-session-account-switching` (base `fb64ba6`, **no PR**) | [ui-03.md](proof/ui-03.md) | UI-02 PR merged and reconciled live |
