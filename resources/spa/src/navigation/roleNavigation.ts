...
const branchManager: NavItem[] = [
  ...
  { key: 'branch.services', label: 'Services', permission: 'service.view', phase: 'Phase 15A', availability: 'planned' },
...
const humanResource: NavItem[] = [
  ...
  { key: 'hr.eligibility', label: 'Service eligibility', permission: 'personnel.eligibility.manage', phase: 'Phase 15B', availability: 'planned' },
...
const finance: NavItem[] = [
  ...
  { key: 'finance.invoices', label: 'Invoices', permission: 'invoice.view', phase: 'Phase 17', availability: 'planned' },
...
const frontOffice: NavItem[] = [
  ...
  { key: 'front-office.clients', label: 'Clients', permission: 'client.view', phase: 'Phase 15A', availability: 'planned' },
  { key: 'front-office.appointments', label: 'Appointments', permission: 'appointment.view', phase: 'Phase 16A', availability: 'planned' },
  { key: 'front-office.walk-ins', label: 'Walk-ins', phase: 'Phase 16B', availability: 'planned' },
  { key: 'front-office.queue', label: 'Queue', permission: 'queue.view', phase: 'Phase 16B', availability: 'planned' },
  { key: 'front-office.service-sessions', label: 'Service sessions', permission: 'service_session.view', phase: 'Phase 16C', availability: 'planned' },
  { key: 'front-office.invoices', label: 'Invoices', permission: 'invoice.view', phase: 'Phase 17', availability: 'planned' },
...
const personnel: NavItem[] = [
  ...
  { key: 'personnel.my-queue', label: 'My queue', permission: 'personnel.my_queue.view', phase: 'Phase 16B', availability: 'planned' },
  { key: 'personnel.my-appointments', label: 'My appointments', permission: 'personnel.my_appointments.view', phase: 'Phase 16A', availability: 'planned' },
  { key: 'personnel.my-sessions', label: 'My sessions', permission: 'personnel.my_sessions.view', phase: 'Phase 16C', availability: 'planned' },
