<template>
  <div class="flex min-h-screen flex-col bg-bg text-text">
    ...
    <header class="border-b border-border bg-surface px-6 py-3">
      <div class="flex items-center justify-between">
        <img
          ...
          class="h-8 w-auto"
        >
        <span class="text-sm font-medium text-text-muted">Front Office</span>
      </div>
    </header>
    <div class="flex flex-1">
      <nav
        aria-label="Front office navigation"
        class="w-64 shrink-0 border-r border-border bg-surface p-4"
      >
        <!-- Phase 11: final navigation items -->
      </nav>
      <main
        id="main-content"
        class="flex-1 p-6"
