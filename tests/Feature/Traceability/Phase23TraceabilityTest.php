...
const P23_VERIFIED_PHASES = [
    ...
    'UI-04',
    // UI-05 merged as PR #55, squash e6664f2ec1c60e55fa27c0a40fa2685a6442932f, sole parent
    // e6afe832fa9b45c4f452bcd43e19338ac87bfd9a, final head 3902633ce992e4973cbe7eaa229dd87dbabc57cb
    // whose tree 64aeb959116940082b9ab4a108b362b73fa3a503 equals the merge tree, merged
    // 2026-08-03T08:46:31Z. Final CI run 30797162231 (five checks SUCCESS); governance comment
    // 5164195590; reviewDecision blank with 0 submitted and 0 approving reviews — a solo-maintainer
    // exception, NOT independent approval. Reconciled live on the
    // phase-ui-06-public-landing-pages branch.
    'UI-05',
    // UI-06 merged as PR #56, squash 6b67ad2e1cc2c1031a89dc8d82902a025feac721, sole parent
    // e6664f2ec1c60e55fa27c0a40fa2685a6442932f, final head e7cac3bf39d8a905094768f281b9343de96a29d3
    // whose tree a83361024c60bb83e2e961de454d6bdc4f99dc6c equals the merge tree, merged
    // 2026-08-04T17:09:51Z. The earlier run 30917088915 failed on two EXTERNAL dependency
    // advisories (a transitive dev-only brace-expansion; Guzzle, fixed in 7.15.2) and an E2E job
    // CANCELLED at a stale 20-minute wall-clock budget with no failing test — not a product
    // defect. Final CI run 30924581598 (five checks SUCCESS); governance comment 5182250114;
    // reviewDecision blank with 0 submitted and 0 approving reviews — a solo-maintainer
    // exception, NOT independent approval. Reconciled live on the
    ...
    // 5269937398 with 0 reviews (not independent approval). UI-10 merged as PR #60 (squash
    // d7988dca), final reviewed head e5f2a6fb, exact-head CI 31667335687 five jobs successful,
    // governance comment 5276187980 and 0 reviews. UI-11 merged as PR #61 (squash dc74e28a),
    // final reviewed head 38bb9014, exact-head CI 31728277786 five jobs successful, equal tree
    // ce181099, governance comment 5284811253 and 0 reviews/approvals. Reconciled live on UI-12.
    'UI-07', 'UI-08', 'UI-09', 'UI-10', 'UI-11',
];

/**
 * The corrective UI/UX programme (Servana_Role_Specific_UI_UX_Subdomain_Software_Development_Plan.md
 * §25). UI-00 … UI-11 are merged and verified; UI-12 is in flight; UI-13 … UI-17 have
...
const P23_UI_PHASES_VERIFIED = [
    'UI-00', 'UI-01', 'UI-02', 'UI-03', 'UI-04', 'UI-05', 'UI-06', 'UI-07', 'UI-08', 'UI-09', 'UI-10', 'UI-11',
];

/** @var list<string> */
const P23_UI_PHASES_UNVERIFIED = [
    'UI-12', 'UI-13', 'UI-14', 'UI-15', 'UI-16', 'UI-17',
];
 ...
 * d7988dca, and Phase UI-11 after PR #61 merged as dc74e28a).
 */
const P23_IN_FLIGHT_PHASE = 'UI-12';
...
const P23_DEFERRABLE_PHASES = [
    '21N', '25', 'UI-13', 'UI-14', 'UI-15', 'UI-16', 'UI-17',
];
...
it('keeps the in-flight phase honest — never verified_complete before its PR merges', function (): void {
    ...
    $premature = array_values(array_map(
        static fn (array $row): string => $row['requirement_id'].': Phase '.P23_IN_FLIGHT_PHASE
            .' cannot be verified_complete before PR merge and CI/governance verification',
        array_filter($inFlight, static fn (array $row): bool => $row['status'] === 'verified_complete'),
    ));

    expect($premature)->toBe([], implode("\n", $premature));
});
