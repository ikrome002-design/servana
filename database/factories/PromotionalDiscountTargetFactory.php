...
/**
 * @extends Factory<PromotionalDiscountTarget>
 */
class PromotionalDiscountTargetFactory extends Factory
{
    protected $model = PromotionalDiscountTarget::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'promotional_discount_id' => PromotionalDiscount::factory(),
