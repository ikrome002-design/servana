...
if (existsSync(join(audit, 'defect-closure.json'))) {
  ...
  if (closure.closures.some((item) => item.lifecycle !== 'local_complete') || closure.local_complete !== closure.closures.length || closure.verified_complete !== 0) problems.push('all UI-11 closures must be local_complete before merge');
}
